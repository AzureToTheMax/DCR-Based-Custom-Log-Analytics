...
$MainPayLoadAppJson = $MainPayLoadApp | ConvertTo-Json -Depth 9	
	...
	$MainPayLoadAppJson  | Out-File "C:\Temp\LogAnalytics\$($AppLogName)-Full.json"
    ...
    Write-Output "Sending Payload..."
        ...
        $ResponseAppInventory = Invoke-RestMethod $AzureFunctionURL -Method 'POST' -Headers $headers -Body $MainPayLoadAppJson
